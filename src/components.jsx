...
const SPORT_CONFIG = {
  hockey:     { label: 'Hockey',     icon: '🏒', color: '#3b8ae6', tint: 'rgba(59,138,230,0.12)', border: 'rgba(59,138,230,0.20)', logo: '/sport-hockey.png',     bgImage: '/hockey-bg.png',     bgPosition: 'center 30%' },
  basketball: { label: 'Basketball', icon: '🏀', color: '#e8832a', tint: 'rgba(232,131,42,0.12)', border: 'rgba(232,131,42,0.20)', logo: '/sport-basketball.png', bgImage: '/basketball-bg.png', bgPosition: 'center 30%' },
  football:   { label: 'Football',   icon: '🏈', color: '#4caf7d', tint: 'rgba(76,175,125,0.12)', border: 'rgba(76,175,125,0.20)', logo: '/sport-football.png',   bgImage: '/football-bg.png',   bgPosition: 'center 40%' },
  baseball:   { label: 'Baseball',   icon: '⚾', color: '#e85252', tint: 'rgba(232,82,82,0.12)',  border: 'rgba(232,82,82,0.20)',  logo: '/sport-baseball.png',   bgImage: '/baseball-bg.png',   bgPosition: '70% center' },
};
